...
<?php if ( have_comments() ) : ?>
	<h3 id="comments" class="h2"><?php comments_number( __( '<span>No</span> Responses <a href="#respond" id="leave-reply">[Leave one]</a>', 'bonestheme' ), 
	     __( '<span>One</span> Response <a href="#respond" id="leave-reply">[Leave your own]</a>', 'bonestheme' ), 
	     _n( '<span>%</span> Response <a href="#respond" id="leave-reply">[Leave your own]</a>', 
	     '<span>%</span> Responses <a href="#respond" id="leave-reply">[Leave your own]</a>', 
